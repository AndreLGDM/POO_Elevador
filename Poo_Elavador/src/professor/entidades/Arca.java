...
public class Arca {
    ...
    public void simularVida() {
        ...
        for (Animal bicho : bichosNoElevador) {
            // afogamentos
            if (bicho instanceof Ave || bicho instanceof AveVoadora
                    || (bicho instanceof Reptil && !(bicho instanceof ReptilAquatico))
            ...
            if (bicho.getTemperaturaIdeal() > elevador.getTemperaturaDoArCondicionado() + 15
                ...
                throw new RuntimeException(
                        bicho.getNome() + " morreu por causa da temperatura!\n" + elevador + "\n" + bicho);
            }
        }
